...
public class liste_restaux extends AppCompatActivity {
    protected ListView maListViewPerso;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_liste_restaux);
        ...
        map.put("img", String.valueOf(R.drawable.restau01_mini));
        ...
        map = new HashMap<>();
        map.put("titre", "Chokolate Restaurant");

        map.put("img", String.valueOf(R.drawable.restau02_mini));
        listItem.add(map);

        map = new HashMap<>();
        map.put("titre", "Restaurant Diona");

        map.put("img", String.valueOf(R.drawable.restau04_mini));
        listItem.add(map);
        ...
        map.put("img", String.valueOf(R.drawable.restau05_mini));
        listItem.add(map);

        map = new HashMap<>();
        map.put("titre", "Tai Shan");
        ...
        maListViewPerso.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder adb = new AlertDialog.Builder(liste_restaux.this);
        ...
        maListViewPerso.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch( position )
                {
                    case 0:  Intent newActivity = new Intent( liste_restaux.this , infos.class);
