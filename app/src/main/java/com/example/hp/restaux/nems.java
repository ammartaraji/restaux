...
public class nems extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        maListViewPerso.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                AlertDialog.Builder adb = new AlertDialog.Builder(nems.this);
        ...
        maListViewPerso.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch( position )
                {
                    case 0:  Intent newActivity = new Intent( nems.this , liste_restaux.class);
                        startActivity(newActivity);
                        break;
                    case 1:  Intent newActivity2 = new Intent(nems.this, liste_restaux2.class);
                        startActivity(newActivity2);
                        break;
                    case 2:  Intent newActivity3 = new Intent(nems.this, tradi.class);
                        startActivity(newActivity3);
                        break;
                    case 3:  Intent newActivity4 = new Intent(nems.this, pizaa.class);
                        startActivity(newActivity4);
                        break;
                    case 4:  Intent newActivity5 = new Intent(nems.this, sushis.class);
